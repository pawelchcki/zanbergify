...
- `razemify_wasm_bg.wasm` (2.4 MB) - The WebAssembly binary
- `razemify_wasm.js` (16 KB) - JavaScript bindings
- `razemify_wasm.d.ts` - TypeScript definitions
