...
This document describes the optional ONNX-based background removal feature added to the Razemify browser app.
...
- **Reference implementation**: `/rust/razemify-core/src/rembg.rs`
...
Same license as parent project (Razemify).
