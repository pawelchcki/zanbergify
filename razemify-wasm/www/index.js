...
async function loadBundledModel() {
    try {
        ...
        const modelConfigs = [
            {
                type: 'rmbg',
                url: 'https://razemify-models-cdn.pawelchcki.workers.dev/rmbg-1.4.onnx',
            ...
            {
                type: 'u2net',
                url: 'https://razemify-models-cdn.pawelchcki.workers.dev/u2net.onnx',
...
async function processImage() {
    ...
    try {
        ...
        showStatus(
            ...
            <a href="${url}" download="razemify-result.png" class="download-link">Download Result</a>`,
            'success'
        );
    } catch (error) {
