...
This guide explains how to deploy the Zanbergify WASM app to Cloudflare Pages using Wrangler.
...
```bash
# From the zanbergify-wasm directory
...
mkdir -p deploy/pkg
cp pkg/zanbergify_wasm.js deploy/pkg/
cp pkg/zanbergify_wasm_bg.wasm deploy/pkg/

# Deploy
wrangler pages deploy deploy --project-name=zanbergify-wasm
```
...
```
https://zanbergify-wasm.pages.dev
```
