...
use zanbergify_core::pipeline::DetailedParams as CoreDetailedParams;
use zanbergify_core::posterize::ColorPalette as CoreColorPalette;
    ...
    pub fn new(thresh_low: u8, thresh_high: u8, clip_limit: f64, tile_size: u32) -> Self {
        Self {
            inner: CoreDetailedParams {
                ...
                clip_limit,
                tile_size,
                palette: zanbergify_core::posterize::PALETTE_ORIGINAL,
            },
        }
    }
...
impl ColorPalette {
    ...
    pub fn original() -> Self {
        Self {
            inner: zanbergify_core::posterize::PALETTE_ORIGINAL,
        }
    }
    ...
    pub fn burgundy() -> Self {
        Self {
            inner: zanbergify_core::posterize::PALETTE_BURGUNDY,
        }
    }
    ...
    pub fn burgundy_teal() -> Self {
        Self {
            inner: zanbergify_core::posterize::PALETTE_BURGUNDY_TEAL,
        }
    }
    ...
    pub fn burgundy_gold() -> Self {
        Self {
            inner: zanbergify_core::posterize::PALETTE_BURGUNDY_GOLD,
        }
    }
    ...
    pub fn rose() -> Self {
        Self {
            inner: zanbergify_core::posterize::PALETTE_ROSE,
        }
    }
    ...
    pub fn cmyk() -> Self {
        Self {
            inner: zanbergify_core::posterize::PALETTE_CMYK,
        }
    }
}
