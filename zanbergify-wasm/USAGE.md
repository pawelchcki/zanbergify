...
```javascript
ZanbergifyProcessor.processImage(imageBytes, params, palette)
```
...
self.onmessage = async (e) => {
    ...
    const result = ZanbergifyProcessor.processImage(imageBytes, params, palette);
