...
WebAssembly bindings for the zanbergify image processing library.
...
**Methods:**
- `ZanbergifyProcessor.processImage(imageBytes, params, palette)` - Process image and return PNG bytes
