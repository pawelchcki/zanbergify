...
class ZanbergifyException implements Exception {
  final String message;
  final int? errorCode;

  const ZanbergifyException(this.message, [this.errorCode]);

  @override
  String toString() {
    if (errorCode != null) {
      return 'ZanbergifyException($errorCode): $message';
    }
    return 'ZanbergifyException: $message';
  }
}
