...
This implementation adds optional ONNX-based background removal to the Zanbergify browser app while maintaining the lightweight design.
...
- `/rust/zanbergify-core/src/rembg.rs` - Exact normalization values
